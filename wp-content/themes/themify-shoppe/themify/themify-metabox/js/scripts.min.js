...
(a.hasClass("multi-ddbtn")?b(".multi-ddbtn-sub",a.parent().parent()).addClass("disabled opacity-5"):c.prev().siblings(".dropdownbutton-list").addClass("disabled opacity-5"))})},togglegroup:function(c){c.find(".themify_toggle_group_wrapper").each(function(){var a=b(this);a.find(".themify_toggle_group_inner").hide();a.on("click",".themify_toggle_group_label",function(a){var c=b(this),d=c.find("i");c=c.next();c.hasClass("is-activated")?(d.removeClass("ti-minus").addClass("ti-plus"),c.hide().removeClass("is-activated")):
(c.show().addClass("is-activated"),d.removeClass("ti-plus").addClass("ti-minus"));a.preventDefault()})})},gallery_shortcode:function(){var c=wp.media.gallery.shortcode,a=wp.media.gallery,d;b("body").on("click",".themify-gallery-shortcode-btn",function(g){var f=b(this).closest(".themify_field").find(".themify-gallery-shortcode-input");f.html()&&(f.val(f.html()),f.html(""),f.text(""));d?d.open():d=0<b.trim(f.val()).length?a.edit(b.trim(f.val())):wp.media.frames.file_frame=wp.media({frame:"post",state:"gallery-edit",
title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:!1});wp.media.gallery.shortcode=function(b){var a=b.props.toJSON(),d=_.pick(a,"orderby","order");b.gallery&&_.extend(d,b.gallery.toJSON());d.ids=b.pluck("id");a.uploadedTo&&(d.id=a.uploadedTo);d._orderbyRandom&&(d.orderby="rand");delete d._orderbyRandom;d.ids&&"post__in"===d.orderby&&delete d.orderby;_.each(wp.media.gallery.defaults,function(b,a){b===d[a]&&delete d[a]});b=new wp.shortcode({tag:"gallery",attrs:d,type:"single"});
f.val(b.string());wp.media.gallery.shortcode=c;return b};d.on("update",function(b){b=wp.media.gallery.shortcode(b).string().slice(1,-1);f.val("["+b+"]")});0==b.trim(f.val()).length&&b(".media-menu").find(".media-menu-item").last().trigger("click");g.preventDefault()})},set_cookie:function(b,a){document.cookie=b+"="+a+"; path=/"},get_cookie:function(b){b+="=";for(var a=document.cookie.split(";"),c=0;c<a.length;c++){for(var g=a[c];" "==g.charAt(0);)g=g.substring(1,g.length);if(0==g.indexOf(b))return g.substring(b.length,
g.length)}return null},enable_toggle:function(){var c=b(".enable_toggle");0<c.length&&c.each(function(){var a=b(this).closest(".themify_write_panel");a.length||(a=b(this).closest("form"));b(".themify-toggle",a).hide().addClass("toggled-off")});b(".enable_toggle .preview-icon").on("click",function(a){var c=b(this).find("img").attr("alt");c=""!=b.trim(c)?"."+c+"-toggle":".default-toggle";b(this).closest(".inside").find(".themify-toggle").hide().addClass("toggled-off");b(this).closest(".inside").find(c).show().removeClass("toggled-off");
a.preventDefault()});b(".enable_toggle .preview-icon.selected").each(function(){var a=b(this).find("img").attr("alt");b(""!=a&&"default"!=a?"."+a+"-toggle":".default-toggle").show().removeClass("toggled-off")});b(".enable_toggle input[type=radio]").on("click",function(){var a=b(this).val();a=0!=a&&""!=a?"."+a+"-toggle":".default-toggle";b(this).siblings("input[type=radio]").each(function(){var a=b(this).val();0!=a&&""!==a&&b("."+a+"-toggle").hide().addClass("toggled-off")});b(a).each(function(){b(this).show().removeClass("toggled-off");
...
b(this).val();setTimeout(function(){0!=a&&""!==a&&b("."+a+"-toggle").hide().addClass("toggled-off")},500)})})});b('.enable_toggle input[type="checkbox"]').on("click",function(){var a=b(this).data("val");a=0!=a&&""!=a?"."+a+"-toggle":".default-toggle";b(this).closest(".inside").find(".themify-toggle").hide().addClass("toggled-off");b(this).prop("checked")&&b(this).closest(".inside").find(a).show().removeClass("toggled-off")});b('.enable_toggle input[type="checkbox"]:checked').each(function(){var a=
b(this).data("val");b(0!=a&&""!==a?"."+a+"-toggle":".default-toggle").show().removeClass("toggled-off")})},query_category:function(){function c(b,a){""!=a?b.closest(".inside").find(".themify_field_row").removeClass("query-field-hide"):b.closest(".inside").find(".themify_field_row").not(b.closest(".themify_field_row")).not(".query-field-visible").addClass("query-field-hide")}var a=b(".themify_field"),d=b(".themify-info-link");a.find(".query_category").blur(function(){var a=b(this),d=a.val();b(this).parent().find(".val").val(d);
c(a,d)}).keyup(function(){var a=b(this),d=a.val();b(this).parent().find(".val").val(d);c(a,d)});a.find(".query_category_single").change(function(){var a=b(this),d=a.val();a.parent().find(".query_category, .val").val(d);c(a,d)}).closest(".themify_field_row").addClass("query-field-visible");d.closest(".themify_field_row").addClass("query-field-visible");b(".query_category_single, .query_category").each(function(){var a=b(this),d=a.val();c(a,d)});d.closest(".themify_field_row").removeClass("query-field-hide")},
post_meta_checkbox:function(){b(".post-meta-group").each(function(){var c=b(this);b(".meta-all",c).prop("checked")&&b(".meta-sub",c).prop("disabled",!0).parent().addClass("opacity-7");c.on("click",".meta-all",function(){b(this).prop("checked")?b(".meta-sub",c).prop("disabled",!0).prop("checked",!1).parent().addClass("opacity-7"):b(".meta-sub",c).prop("disabled",!1).parent().removeClass("opacity-7")})});b(".custom-post-meta-group").each(function(){var c=b(this),a=b('input[type="text"]',c).val(),d=
{},e=[],f=[];if("yes"===a)b(".meta-all",c).val("yes").prop("checked",!0),b(".meta-sub",c).val("yes").prop("disabled",!0).parent().addClass("opacity-7");else{f=a.split("&");for(a=0;a<f.length;a++)e=f[a].split("="),d[e[0]]=e[1];for(var h in d)d.hasOwnProperty(h)&&"yes"===d[h]&&b("#"+h,c).val("yes").prop("checked",!0);b(".meta-all",c).prop("checked")&&b(".meta-sub",c).prop("disabled",!0).prop("checked",!1).parent().addClass("opacity-7")}c.on("click",".meta-all",function(){var a=b(this);a.prop("checked")?
(b(".meta-sub",c).val("yes").prop("disabled",!0).prop("checked",!1).parent().addClass("opacity-7"),a.val("yes")):(b(".meta-sub",c).val("no").prop("disabled",!1).parent().removeClass("opacity-7"),a.val("no"));k(c)});c.on("click",".meta-sub",function(){var a=b(this);a.prop("checked")?a.val("yes"):a.val("no");k(c)})})},pagination:function(c){c.on("click","#themify_assignments_popup_show .themify-popup-visibility-tab",function(a){a.preventDefault();var c=b(this);if(!c.data("active")){a=c.data("type");
var e=c.parents("#themify_assignments_popup_show").find(".themify-assignment-type-options[data-type="+a+"]"),f=b("#popup_show-assignment-tab-pages").data("post-id");jQuery.ajax({url:ajaxurl,type:"post",data:{action:"themify_create_inner_popup_page",type:a,post_id:f},beforeSend:function(){},success:function(a){e.html(a);c.data("active","on")}})}});c.on("click",".themify-assignment-pagination .page-numbers",function(a){a.preventDefault();a=b(this);var c=a.parents(".themify-assignment-options"),e=a.parents(".themify-assignment-items-inner"),
f=b(".themify-assignment-pagination",e),h=parseFloat(b(".themify-assignment-pagination .current",e).text()),l=1;a.hasClass("next")?l=h+1:a.hasClass("prev")?l=h-1:a.hasClass("page-numbers")&&(l=parseFloat(a.text()));var k=b(".themify-assignment-items-inner",c);b.ajax({url:ajaxurl,type:"post",data:{action:"themify_create_popup_page_pagination",current_page:l,num_of_pages:e.data("pages")},beforeSend:function(){b(".tb_slider_loader",c).remove();b(".themify-assignment-items-page",e).addClass("is-hidden");
f.hide();k.append('<div class="tb_slider_loader"></div>')},success:function(a){b(".tb_slider_loader",c).remove();b(".themify-assignment-items-page-"+l,e).removeClass("is-hidden");f.html(a).show()}})})}};e.init();return e}(jQuery);
